  ...
  partial class TaskView {
    ...
    private void InitializeComponent() {
      ...
      this.mvvmContext1.BindingExpressions.AddRange(new DevExpress.Utils.MVVM.BindingExpression[] {
            DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(sample_7_5.ViewModels.TaskViewModel), "Postpone", this.bbiPostpone),
            DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(sample_7_5.ViewModels.TaskViewModel), "MarkDone", this.bbiMarkDone)});
